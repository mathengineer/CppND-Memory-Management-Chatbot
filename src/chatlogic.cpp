...
ChatLogic::~ChatLogic()
{
    ...
    // delete all nodes: no longer needed 
    // since we are using std::vector<std::unique_ptr<GraphNode>> _nodes
...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            // create new edge
                            // just so that I can use move semantics
                            // I think raw pointer is also OK, just let unique_ptr take over the ownership
                            ...
                            // this is the move required in rubric
    ...
    // move to pass chatBot to rootNode
